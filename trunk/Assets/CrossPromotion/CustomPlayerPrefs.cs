 ...
 * Date: August 2015
 * 
 * Intro: This class has been modified to change saving disk path only. 
 * Rest of the implementation has been provided by 'PreviewLabs'
 */
...
namespace PreviewLabs
{
	public static class CustomPlayerPrefs
	{
		...
		private static readonly string fileName = Application.persistentDataPath + "/CustomCrossPromotionData.txt";
		...
		{			
			if(playerPrefsHashtable.ContainsKey(key))
			{
				Debug.Log("key: " + key + " val: " + playerPrefsHashtable[key].ToString());
