...
/**
 * Check to see is the base URL is set. 
 * Used for determining if an open request has been made.
 **/
BOOL PHBaseURLIsSet();

/**
 * Returns the location access setting for this session
 **/
BOOL PHGetLocationAccessAllowed();

/**
 * Sets the location access setting for this session
 **/
void PHSetLocationAccessAllowed(BOOL allowed);

/**
 * Returns the cache creative setting for this session
 **/
BOOL PHGetShouldCacheCreative();

/**
 * Sets the cache creative setting for this session
 **/
void PHSetShouldCacheCreative(BOOL cacheCreative);
 ...
 * URL substitution
 **/
#define PH_URL_VAR_OPEN     @"={"
#define PH_URL_VAR_CLOSE    @"}"
#define PH_URL_OPEN_OFFSET  2

/**
 * Preloading
 **/
#define PH_DOWNLOAD_DIRECTORY @"ph"
#define PH_CACHE_USER_DEFAULT_KEY @"ph_preloading"

/**
 * Video
 **/
#define PH_VIDEO_TIMOUT_NOTIFICATION @"ph_video_timeout_notification"
