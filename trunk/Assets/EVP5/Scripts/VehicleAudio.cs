...
public class VehicleAudio : MonoBehaviour
	...
	void DoEngineExtraAudio ()
		...
		float updatedTurboRatio = Mathf.InverseLerp(engineExtras.turboMinRpm, engineExtras.turboMaxRpm, m_engineRpm) * Mathf.Clamp01(m_vehicle.throttleInput);
	...
	void DoBodyDragAudio ()
		...
		if (drags.scratchAudioClip != null)
			...
			if (dragSpeed > drags.scratchMinSpeed
				...
				&& Time.fixedTime-m_lastScratchTime > drags.scratchMinInterval)
				{
